...
///////////////////////////////////////WORKING CODE HERE//////////////////////////////////////////////////
   ...
   ////////////////////////CHEKING EXCLUSIVITY AFTER FILL///////////////////////////
            ...
            //  wayyy=ooo_cpu[cpu].L1D.check_hit(&MSHR.entry[mshr_index]);
            //    if(wayyy>=0)
            //     {printf("HIT at: %d level\n", (CACHE *)ooo_cpu[cpu].L1D.cache_type);
            //      cntr++;
            //     }
            //         else
            ...
            if (wayyy >= 0)
            {
                // printf("HIT at: %d level\n", lowercheckk->cache_type);
                cntr++;
            }
            // else
                // printf("MISS at: %d level\n", lowercheckk->cache_type);

            CACHE *lower1checkk = (CACHE *)lowercheckk->lower_level;
            wayyy = lower1checkk->check_hit(&MSHR.entry[mshr_index]);
            if (wayyy >= 0)
            {
                // printf("HIT at: %d level\n", lower1checkk->cache_type);
                cntr++;
            }
            // else
                // printf("MISS at: %d level\n", lower1checkk->cache_type);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
  ...
  /////////////////////////////////////INVALIDATING///////////////////////////////////////////////
   ...
   ////////////////////CHECKING WQ ADDR for Exlusivity after filling//////////////
                    ...
                    // printf("SHIT DUE TO WQ");
                    //  wayy=ooo_cpu[cpu].L1D.check_hit(&WQ.entry[index]);
                    //    if(wayy>=0)
                    //     {printf("HIT at: %d level\n", (CACHE *)ooo_cpu[cpu].L1D.cache_type);
                    //      cntr++;
                    //     }
                    ...
                    CACHE *lowercheck = (CACHE *)ooo_cpu[cpu].L1D.lower_level;
                    wayy = lowercheck->check_hit(&WQ.entry[index]);
                    if (wayy >= 0)
                    {
                        // printf("HIT at: %d level\n", lowercheck->cache_type);
                        cntr++;
                    }
                    // else
                        // printf("MISS at: %d level\n", lowercheck->cache_type);
                    CACHE *lower1check = (CACHE *)lowercheck->lower_level;
                    wayy = lower1check->check_hit(&WQ.entry[index]);
                    if (wayy >= 0)
                    {
